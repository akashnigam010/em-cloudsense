 ...
 *
 *	A bill object which has been processed at cloud side, will be kept as part of Processed bill.
 *	A bill id which has been successfully updated in cloud database will be listed under succeeded bill id 
 *  and bill id which has been failed will be added to failed bill id. 
 */
public class ProcessedBill {
	 ...
	 * 
	 * @return succeededBillIds		collection of bill ids which has been successfully updated in cloud database.
	 */
	 ...
	 * 
	 * @param succeededBillIds 	Collection of billIds which has been updated successfully in cloud database.
	 */
